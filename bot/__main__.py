...
'''
        ...
        sendMarkup(f'Dear {uname},\n\nIf You Want To Use Me, You Have To Join @{CHANNEL_USERNAME}\n\n\n<b>Havent Slept Since:</b> <code>{uptime}</code>/n<b>NOTE:</b> All The Uploaded Links and Leeched Files By You Will Be Sent Here In Your Private Chat From Now.', context.bot, update.message, reply_markup)
