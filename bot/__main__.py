...
def restart(update, context):
    restart_message = sendMessage("Bot Restarting...Please Wait...", context.bot, update.message)
    if Interval:
        Interval[0].cancel()
    alive.kill()
    clean_all()
...
def ping(update, context):
    ...
    reply = sendMessage("Starting Ping..Please Wait..", context.bot, update.message)
